        ...
        <div className="container">
            ...
            <div className="diagram-wrap" style={{ aspectRatio: '1600 / 1500' }}>
              <svg className="diagram" viewBox="0 0 1600 1500" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet">
                ...
                <g>
                  ...
                  <g transform="translate(1210, 555)"><rect width="280" height="70" fill="url(#panel-grad)" stroke="#1e2a5c" /><rect x="277" y="0" width="3" height="70" fill="#1e6fff" /><text className="svg-tag" x="16" y="22" fontSize="9">⬢ Register CATALOG</text><text className="svg-serif" x="16" y="42" fontSize="13">Drinks · Bottles · Cover</text><text className="svg-mono" x="16" y="58" fontSize="8" fill="#7c8db8">cash + card only · voids logged</text></g>
          ...
          <div className="tier-section">
            ...
            <div className="tier-grid">
              ...
              <div className="tier" style={{ ['--tier-color']: '#3b82f6' }}><div className="rank">TIER <em>03</em></div><h4>Staff</h4><ul><li>Register · bar · door</li><li>Own shift data</li><li>Tip pool visible</li><li>Clock self in/out</li><li>No financials</li></ul></div>
            ...
            <div className="tech-tabs">
              <div className="tech-tab" style={{ ['--tab-color']: '#00d4ff' }}>
                ...
                <ul>
                  ...
                  <li><span className="k">PRINT · SIGN</span><span className="v"><b>Epson ET-5850</b> prints contract → manual wet signature → <b>Epson WiFi PDF scanner</b> rescans signed hardcopy back into the record. Thermal receipt printer for Register. <b>SVC machine</b> for GlyphBucks issuance. <em>Print → Sign → Rescan → Sealed</em></span></li>
          ...
          <div className="capabilities">
            ...
            <div className="cap">
              ...
              <p>Register product catalog with cost basis, par levels, and pour tracking. Bartender voids and comps logged to audit trail.</p>
            </div>
            <div className="cap">
              ...
              <p>Primary entity store with row-scoped isolation by <code style={{ color: 'var(--cyan)' }}>venue_id</code>. The current codebase contains 250+ backend functions and 160+ entity schemas under platform governance, supporting the breadth of NUPS operational modules from commerce through audit and venue workflow.</p>
            </div>
            <div className="cap">
