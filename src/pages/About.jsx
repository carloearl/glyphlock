...
const storyChapters = [
  {
    ...
    body: "In early 2025, Carlo Rene Earl was talking about camouflage when the conversation shifted: what if an image could do more than show something? What if the pixels themselves could carry a hidden, machine-readable data layer—like a QR code without a visible square—while the image also opened links, hotspots, identity, and provenance?",
    supporting: "That question became working LSB steganography encode/decode experiments, an interactive image system, and a Secure QR catalog containing 91 payload structures. The hidden-image carrier remains an active, not-yet-public core technology direction; the QR catalog, Image Lab, and hotspot surfaces make the larger idea tangible today.",
    icon: QrCode,
  },
  {
    number: "02",
