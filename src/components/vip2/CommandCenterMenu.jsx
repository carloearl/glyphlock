...
import { LayoutDashboard, FileSignature, DoorOpen, Users, Search, Coins, Layers, Banknote } from "lucide-react";
...
const CARDS = [
  ...
  { key: "Press", title: "Legacy & Press", desc: "Legacy Dance Dollars agreement & the GlyphBucks bill press — design, print & archive", icon: Banknote, glow: "bg-green-500/25", accent: "text-green-300" },
