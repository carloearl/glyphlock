      ...
      <div className="relative z-10 container mx-auto px-4 max-w-6xl py-12 md:py-24">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div>
            ...
            >
              <span
                className="block text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-black leading-[0.95]"
                style={{
                  letterSpacing: '-1px',
                  background: 'linear-gradient(135deg, #ffffff 0%, #fbbf24 30%, #10b981 60%, #ffffff 100%)',
