...
export default function SEOHead({ 
  ...
  useEffect(() => {
    ...
    // The canonical Organization/WebSite/product identity graph is emitted
    // statically in index.html so crawlers receive it in the raw response.
    // Base44 platform JSON-LD must remain disabled in Dashboard > SEO & GEO > Advanced SEO.
