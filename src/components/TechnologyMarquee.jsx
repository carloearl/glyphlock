...
// Row configs: all rows identical to bottom row, just with varying opacity
const ROW_CONFIGS = [
  { rotateX: 0, scaleX: 1.00, opacity: 0.45, mb: 28 },
  { rotateX: 0, scaleX: 1.00, opacity: 0.70, mb: 28 },
