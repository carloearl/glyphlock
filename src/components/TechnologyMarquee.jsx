...
const ROWS = [
  {
    ...
    logos: [
      ...
      { name: "Azure",         src: logo("microsoft.com") },
      ...
      { name: "Terraform",     src: logo("hashicorp.com") },
      ...
      { name: "Vault",         src: logo("hashicorp.com") },
      ...
      { name: "GitLab CI",     src: logo("gitlab.com") },
    ],
  },
  {
    duration: "70s",
    ...
    logos: [
      ...
      { name: "Firebase",      src: logo("firebase.com") },
      ...
      { name: "Remix",         src: logo("shopify.com") },
