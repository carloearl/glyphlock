...
import { Music, Search, Disc, Zap, Activity, Radio, RadioTower, Stethoscope } from 'lucide-react';
...
const TABS = [
  ...
  { key: 'radio', label: 'Radio', icon: RadioTower, active: 'bg-amber-500/20 text-amber-300 border-amber-500/50' },
