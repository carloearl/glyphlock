      ...
      <motion.div initial={{opacity:0,y:30}} whileInView={{opacity:1,y:0}} viewport={{once:true}} className="relative rounded-[30px] border border-cyan-400/30 bg-slate-950/[.65] backdrop-blur-xl p-5 md:p-9 shadow-[0_0_70px_rgba(6,182,212,.18),0_0_120px_rgba(124,58,237,.12)]">
        ...
        <div className="relative flex flex-col lg:flex-row lg:items-end justify-between gap-6 mb-8">
          <div>
            ...
            <p className="mt-4 max-w-3xl text-base md:text-xl text-slate-300 leading-relaxed">Nexus Unified Portal System is GlyphLock's flagship venue-operations platform in controlled development and evaluation, connecting front-door workflows, venue register, contracts, staff operations, payouts, records, reporting, QR operations and integrations in one operating surface.</p>
          </div>
          <div className="flex flex-wrap gap-3">
            ...
            <Link to="/NUPSKiosk" className="inline-flex items-center gap-2 rounded-xl border border-violet-300/70 bg-violet-500/20 px-6 py-3.5 font-black text-violet-50 shadow-[0_0_28px_rgba(139,92,246,.4),0_0_70px_rgba(139,92,246,.14)] hover:-translate-y-1 hover:scale-105 hover:bg-violet-400 hover:text-white hover:shadow-[0_0_48px_rgba(139,92,246,.65)] transition-all duration-300"><ShieldCheck className="w-4 h-4"/> ENTER SYSTEM</Link>
          </div>
        </div>
