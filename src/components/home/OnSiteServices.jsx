...
const SERVICES = [
  ...
  { title: 'Venue Register Systems', desc: 'Register hardware, receipt printers, card readers, and setup.', icon: CreditCard, color: '#f59e0b' },
  { title: 'NUPS Deployment', desc: 'Full venue operating system — Register, accounting, and compliance.', icon: Building2, color: '#ec4899' },
    ...
    <section className="w-full max-w-7xl mx-auto px-4 py-16">
      <div className="text-center mb-10">
        ...
        <p className="text-white/70 text-base md:text-lg max-w-3xl mx-auto leading-relaxed">
          ...
          One team for hardware, software, networks, venue register, and audio.
        </p>
      </div>
