...
const CONTRACT_SECTIONS = `1. Orders
...
Club Currency is to be used exclusively for legal purposes within the Club/Bar and is of no value outside of these premises. It must not be used for illegal acts; if such use is detected, the Club Currency will be forfeited to the company. Refunds for Club Currency are managed through the Club/Bar Management Office at 602-536-0372.
...
export default function DreamPalaceContractText({ acks, setAcks, allAcked, onBack, onNext }) {
  return (
