...
Public traffic passes through unchanged. The crawler-prerender fallback remains disabled until the corrected Base44 application is published and the protected-route verification proves the built-in renderer still fails.
